...
class Architecture(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        self.L2_sqr = (
            ...
            + (self.outputLayer.W ** 2).sum() + (self.hiddenLayer2.W ** 2).sum() + (self.hiddenLayer3.W ** 2).sum() + (self.hiddenLayer4.W ** 2).sum() + (self.hiddenLayer5.W ** 2).sum()
        )
        ...
        self.params = self.hiddenLayer.params + self.hiddenLayer2.params + self.hiddenLayer3.params + self.hiddenLayer4.params + self.hiddenLayer5.params+ self.outputLayer.params
